...
|----------|---|---|------|-----|-----|-----|-----|-----|-------|
| simple | 100 | 10 | 3.22ms | 311 | 2.90ms | 7.47ms | 2.43ms | 9.25ms | 100 |
| compound | 100 | 10 | 3.99ms | 250 | 3.73ms | 8.05ms | 2.98ms | 9.36ms | 100 |

## Results: N=1_000, M=100

| Approach | N | M | Mean | TPS | P50 | P99 | Min | Max | Iters |
|----------|---|---|------|-----|-----|-----|-----|-----|-------|
| simple | 1_000 | 100 | 3.13ms | 319 | 2.97ms | 5.91ms | 2.41ms | 7.20ms | 100 |
| compound | 1_000 | 100 | 3.94ms | 253 | 3.64ms | 8.67ms | 2.92ms | 15.93ms | 100 |

## Results: N=10_000, M=100

| Approach | N | M | Mean | TPS | P50 | P99 | Min | Max | Iters |
|----------|---|---|------|-----|-----|-----|-----|-----|-------|
| simple | 10_000 | 100 | 4.73ms | 211 | 4.40ms | 8.65ms | 3.44ms | 8.68ms | 100 |
| compound | 10_000 | 100 | 4.05ms | 247 | 3.76ms | 6.70ms | 3.10ms | 13.69ms | 100 |
