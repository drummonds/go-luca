...
|------|---|---|------|-----|-----|-----|-----|-------|
| scv | 1_000 | 21 | 3.15ms | 2.87ms | 5.46ms | 1.88ms | 5.69ms | 50 |

## Results: 10_000 accounts, 199 customers

| Type | N | M | Mean | P50 | P99 | Min | Max | Iters |
|------|---|---|------|-----|-----|-----|-----|-------|
| scv | 10_000 | 199 | 21.18ms | 20.22ms | 26.46ms | 17.88ms | 33.69ms | 20 |

## Results: 100_000 accounts, 1_989 customers

| Type | N | M | Mean | P50 | P99 | Min | Max | Iters |
|------|---|---|------|-----|-----|-----|-----|-------|
| scv | 100_000 | 1_989 | 216.29ms | 210.46ms | 225.83ms | 196.28ms | 252.36ms | 5 |

## Results: 1_000_000 accounts, 19_677 customers

| Type | N | M | Mean | P50 | P99 | Min | Max | Iters |
|------|---|---|------|-----|-----|-----|-----|-------|
| scv | 1_000_000 | 19_677 | 1.863s | 1.863s | 1.863s | 1.863s | 1.863s | 1 |
