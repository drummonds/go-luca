...
func IntToDecimal(amount int64, exponent int) decimal.Decimal {
	return decimal.New(amount, int32(exponent))
}
...
func DecimalToInt(d decimal.Decimal, exponent int) int64 {
...
func ScaleAmount(amount int64, fromExponent, toExponent int) int64 {
